            ...
            <div className="make_a_difference_grid">
                <div className="make_a_difference_box">
                    ...
                    <div className="make_a_difference_box_content">
                        ...
                        <hr />
                        <h2>Helping families understand and accept their LBT members.</h2>
                        <Link to=''>                   
                ...
                <div className="make_a_difference_box">
                    <div className="make_a_difference_box_grid">
                        <div className=" make_a_difference_box_image_second">
                            <img src={diference_2} alt="" />
                        </div>
                        <div className="make_a_difference_box_content">
                            <p style={{display:'flex', alignItems:'center', margin:'20px 0 10px 0', gap:'20px'}}>
                                <span>
                    ...
                    <div className="make_a_difference_box_grid" style={{marginTop:'40px'}}>
                        <div className=" make_a_difference_box_image_second">
                            <img src={diference_3} alt="" />
                        </div>
                        <div className="make_a_difference_box_content">
                            <p style={{display:'flex', alignItems:'center', margin:'20px 0 10px 0', gap:'20px'}}>
                                <span>
