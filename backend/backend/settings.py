...
SECRET_KEY = 'django-insecure-x-=*9m9z^x9rbavgr*l-wjg#hv=ll+j=ea)*glp(a!m--n(=@r'
...
CKEDITOR_5_CONFIGS = {
    'default': {
        'toolbar': ['heading', '|', 'bold', 'italic', 'bulletedList', 'link', 'alignment', 'blockQuote', 'numberedList', ],
    },
}
...
JAZZMIN_SETTINGS = {
    "site_title": "Admin | UFC",
    "site_header": "Unity for Change",
    "site_brand": "Unity for Change",
    # "site_icon": "images/logo.png",
    # "site_logo": "images/logo.png",
    "welcome_sign": "Welcome, UFC Admin!",
    "copyright": "Unity for Change",
    "topmenu_links": [
